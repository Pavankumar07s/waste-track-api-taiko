...
const manufacturers_service_1 = require("./graphql/manufacturers.service");
const manufacturers_resolver_1 = require("./graphql/manufacturers.resolver");
const manufacturers_controller_1 = require("./rest/manufacturers.controller");
...
exports.ManufacturersModule = ManufacturersModule = __decorate([
    (0, common_1.Module)({
        providers: [manufacturers_resolver_1.ManufacturersResolver, manufacturers_service_1.ManufacturersService],
